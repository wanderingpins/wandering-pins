...
// shape as InlineHoldingDetails, minus the front/back/other distinction —
// check-in photos have no `kind`, always private, capped at
// MAX_CHECKIN_PHOTOS.
export function InlineCheckInDetails({
  ...
  // second save in a row still returns a fresh { status: "ok" } object each
  // time, but the status string would otherwise look unchanged from the
  // last render and never re-trigger the collapse.
